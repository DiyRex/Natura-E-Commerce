...
<html lang="en">
    <head>
        ...
        <title>Search results for <%=request.getAttribute("pageTitle")%></title>
        <style>
            .fit-image {
                width: 100%;
                height: 200px;
    ...
    <body class="d-flex flex-column min-vh-100">
        ...
        <div class="container-md mt-5 flex-grow-1">
            <br>
            <br>
            <div class="mt-4">
                <h1 class="text-center h4 fw-bold mt-5">Search Results for <%=request.getAttribute("pageTitle")%></h1>
            </div>
            <div class="row mt-5" >
                <!-- Start Card -->
                ...
                %>
                <h1 class="text-center text-muted h5 fw-bold mt-2">No products found :(</h1>
                <%}%>
                <!-- end Card -->
            </div>
        </div>
